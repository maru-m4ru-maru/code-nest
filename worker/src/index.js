  ...
  async fetch(request, env) {
    ...
    if (
      ...
      try {
        ...
        if (action !== "set") {
          return json(
            {
              error: "Unsupported cloud action"
            },
            400,
            cors
          );
        ...
        if (!variable || variable.length > 200) {
          return json(
            {
              error: "Invalid cloud variable name"
            },
            400,
            cors
          );
        ...
        if (!ws) {
          return json(
            {
              error:
                "Scratch cloud WebSocket was not accepted"
            },
            502,
            cors
          );
    ...
    if (
      ...
      const previewPageUrl =
        "https://maru-m4ru-maru.github.io/code-nest/shared-preview.html?id=" +
